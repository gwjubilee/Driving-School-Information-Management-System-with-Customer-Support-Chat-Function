...
<div class="main">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      ?>
      <h3 data-aos="fade-up" style="margin-top: 20px;"><?=$getUserRow['instructor_name']?></h3>
  </div>
</nav>
    <div class="container" style="margin-bottom: 100px; background-color: #23272a; width: 70%; margin:auto;">
        <?php
            $getReceiver = "SELECT * FROM student WHERE student_email = '$receiver'";
            ...
            $received_by = $getReceiverRow['student_email'];
        ?>
        <div class="card mt-4" style="background-color: #2c2f33;">
            <div class="card-header">
                <h6><strong><?=$getReceiverRow['student_name']?></strong><br /><i class="text-warning"><?=$receiver?></i></h6>
            </div>
            <?php
