...
<div class="text-center">
  ...
  <div data-aos="fade-up" class="row" style="margin-top: 30px; margin-bottom: 50px;">
	...
	<div class="col-9 flex" style="margin-left: 70px;">
		<h3 data-aos="fade-up" data-aos-duration="1000" style="margin-bottom: 20px;"><span class="text-warning"></span></h3>
           ...
           <table class="styled-table">
			...
			<tbody> 
				...
				if($result->num_rows==0) {
					echo '
					<div class="row" style="position: absolute; margin-top: 100px; left: 24%;">
					<div data-aos="fade-up" class="col">
